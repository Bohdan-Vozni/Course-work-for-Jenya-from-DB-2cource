...
(
	...
	HDD_ID CHAR(36)  NULL FOREIGN KEY(HDD_ID) REFERENCES HDD(HDD_ID),
	SSD_ID CHAR(36) NULL FOREIGN KEY(SSD_ID) REFERENCES SSD(SSD_ID),

	PowerSupply_ID CHAR(36) NOT NULL FOREIGN KEY(PowerSupply_ID) REFERENCES PowerSupply(PowerSupply_ID),

	WaterCooling_ID CHAR(36) NULL FOREIGN KEY(WaterCooling_ID) REFERENCES WaterCooling(WaterCooling_ID),
	FanCooling_ID CHAR(36)  NULL FOREIGN KEY(FanCooling_ID) REFERENCES FanCooling(FanCooling_ID),
